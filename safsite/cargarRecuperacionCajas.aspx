<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cargarRecuperacionCajas.aspx.cs" Inherits="cargarRecuperacionCajas" %>
...
<body>
    ...
    <div class="container">
        ...
        <asp:Button ID="btnEmitirSolicitud" runat="server" Text="Emitir Solicitud" Width="146px" CssClass="btn btn-success" OnClick="btnSolicitud_click" />   
        <br />
